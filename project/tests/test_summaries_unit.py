...
def test_update_summary_invalid(test_app, monkeypatch, summary_id, payload, status_code, detail):
    ...
    WHEN the PUT method is called with various parameters
    THEN return the respective error status code
    """
...
def test_update_summary_invalid_url(test_app):
    """
    GIVEN test_app
    WHEN the PUT method is called with an invalid url
    THEN return status 422
    """
    response = test_app.put(
        "/summaries/1/",
